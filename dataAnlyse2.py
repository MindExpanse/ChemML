...
data = pd.read_excel('data20240429.xlsx', sheet_name=0)[['Ueff/K', 'θ1/°', 'd1/Å', 'θ2/°', 'd2/Å']]
...
plt.savefig(os.path.join(fig_dir, 'Histogram-1.png'), dpi=900, bbox_inches='tight')
plt.show()
...
# 绘制相关性热图
sns.heatmap(correlation_matrix, annot=True, cmap='RdYlBu', xticklabels=[r'$U_{eff}(cm^{-1})$', r'$θ_1$', r'$d_1$', r'$θ_2$', r'$d_2$'], yticklabels=[r'$U_{eff}(cm^{-1})$', r'$θ_1$', r'$d_1$', r'$θ_2$', r'$d_2$'])
plt.title('Correlation Heatmap')
plt.savefig(os.path.join(fig_dir, 'Correlation-1.png'), dpi=900, bbox_inches='tight')
plt.show()
