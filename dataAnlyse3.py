...
# data = pd.read_excel('data20240401.xlsx', sheet_name=1)[['Ueff/K', 'θ1/°', 'd1/Å', 'θ2/°', 'd2/Å']]
data = pd.read_excel('data20240429.xlsx', sheet_name=1)[['Ueff/K', 'θ1/°', 'd1/Å', 'θ2/°']]
# data = pd.read_excel('data20240426.xlsx', sheet_name=0)[['Ueff/K', 'θ1/°', 'd1/Å', 'θ2/°']]
...
# 绘制相关性热图
sns.heatmap(correlation_matrix, annot=True, cmap='RdYlBu', xticklabels=[r'$U_{eff}(cm^{-1})$', r'$θ_1$', r'$d_1$', r'$θ_2$'], yticklabels=[r'$U_{eff}(cm^{-1})$', r'$θ_1$', r'$d_1$', r'$θ_2$'])
plt.title('Correlation Heatmap')
plt.savefig(os.path.join(fig_dir, 'Correlation-2.png'), dpi=900, bbox_inches='tight')
plt.show()

# 绘制自变量和因变量之间的散点图
sns.pairplot(data, x_vars=['θ1/°', 'd1/Å', 'θ2/°'], y_vars=['Ueff/K'], kind='scatter')
plt.show()
